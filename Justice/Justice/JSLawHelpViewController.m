...
@interface JSLawHelpViewController ()

@end

@implementation JSLawHelpViewController

- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil];
    if (self) {
        self.title = @"法律援助";
        UIImage *normalImage = [UIImage imageNamed:@"LawHelp"];
        UIImage *selectedImage = [UIImage imageNamed:@"LawHelpHighlighted"];
...
- (void)viewDidLoad {
    ...
    NSString *filePath = [[NSBundle mainBundle]pathForResource:@"lawhelp" ofType:@"html"];
